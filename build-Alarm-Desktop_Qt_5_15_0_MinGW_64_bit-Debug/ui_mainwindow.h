...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_3->addWidget(pushButtonalex_5, 3, 2, 1, 2);
        ...
        gridLayout_3->addWidget(pushButtonalex, 2, 2, 1, 2);
